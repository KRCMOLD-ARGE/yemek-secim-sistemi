(function(){
  ...
  let wasReady=false,manuallyClosed=false;
  ...
  function ensureStyle(){
    ...
    const s=document.createElement('style');s.id='krawOrderListStyle';s.textContent=`
      ...
      .kraw-order-done{margin:14px 18px 18px;padding:11px 12px;background:#0b5b46;border:1px solid #16745c;border-radius:10px;color:#d8fff0;font-weight:800;text-align:center}
      .kraw-order-pending{margin:14px 18px 18px;padding:11px 12px;background:#174d79;border:1px solid #2d6c9f;border-radius:10px;color:#e8f4ff;font-weight:800;text-align:center}
